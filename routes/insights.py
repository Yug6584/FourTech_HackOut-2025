...
# Create a Blueprint instance for the insights routes.
# The name 'insights_bp' is used to register it in app.py.
...
insights_bp = Blueprint('insights_bp', __name__, template_folder='../templates', static_folder='../static')
