...
# Create a Blueprint instance for the suggestions routes.
# The name 'suggestions_bp' is used to register it in app.py.
...
suggestions_bp = Blueprint('suggestions_bp', __name__, template_folder='../templates', static_folder='../static')
